<h1>Hi, I'm Kasper Ng Bergan 👋</h1>

I study Applied Robotics at NMBU (Norwegian University Of Life Sciences)
(Expected 2028). Aspiring to learn more about the field of Robotics both through
software and hardware.

## Skill Set :muscle:

These are some of the major technologies that I use or have worked on in the past ranked from most experience to least:
...
#### Racecar Gazebo environment

Simulates an Ackermann-steered vehicle with a mounted camera in Gazebo, visualizing the camera feed in RViz using ROS 2.

**Repo:** [racecar_gazebo](https://github.com/KasNgB/racecar_gazebo) 

#### YOLO + RTSP Realtime Detection
...
**Linkedin:** [Kasper Ng Bergan](https://www.linkedin.com/in/kasper-ng-bergan-09322a3ab/)
